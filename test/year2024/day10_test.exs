defmodule Year2024.Day10Test do
  use ExUnit.Case, async: true

  @input_path Path.expand("../../priv/year2024/day10/input.txt", __DIR__)
  ...
  describe "part 1" do
    test "works with the first simple example" do
      ...
      9876
      """
      assert Year2024.Day10.part(1, sample) == 1
    end
    ...
    test "works with the sample input" do
      ...
      10456732
      """
      assert Year2024.Day10.part(1, sample) == 36
    end

    @tag :skip
    test "works with the real input" do
      input = File.read!(@input_path)
      assert Year2024.Day10.part(1, input) == :not_implemented
    end
  end
  ...
  describe "part 2" do
    test "works with the first example" do
      ...
      ..9....
      """
      assert Year2024.Day10.part(2, sample) == 3
    end
    ...
    test "works with the second example" do
      ...
      987....
      """
      assert Year2024.Day10.part(2, sample) == 13
    end
    ...
    test "works with the large sample input" do
      ...
      10456732
      """
      assert Year2024.Day10.part(2, sample) == 81
    end

    @tag :skip
    test "works with the real input" do
      input = File.read!(@input_path)
      assert Year2024.Day10.part(2, input) == :not_implemented
    end
  end
